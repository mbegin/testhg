...
initialize = function(opts){
    ...
    *   ...
    */
    d3.json("https://cdn.jsdelivr.net/gh/mbegin/testhg@master/data/users.json", function(json, error) {
        if (error) return;
        users = json;
...
initializeUser = function(user) {
    ...
    d3.json("https://cdn.jsdelivr.net/gh/mbegin/testhg@master/data/user-data/" + user.id + ".json", function(json, error) {
        if (error) return;
